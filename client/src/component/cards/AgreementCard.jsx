              ...
              <MDBCardBody>
                ...
                <MDBCardBody>
                  ...
                  <MDBInput
                    ...
                    type="date"
                    label="BirthDay"
                    defaultValue="2023-01-29"
                    name="date"
                    onChange={(e) => formInputs(e)}
                  />
                ...
                <MDBBtn
                  disabled={sendForm ? false : true}
                  className="float-start mt-4 mb-4"
                  href="#"
                  onClick={submitForm}
                >

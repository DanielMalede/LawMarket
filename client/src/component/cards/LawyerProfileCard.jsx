          ...
          <MDBCol>
            <MDBCard>
              <div
                ...
                style={{
                  backgroundImage: `url(${lawyer?.selectedCover})`,
              ...
              >
                ...
                >
                  <MDBCardImage
                    ...
                    className="rounded-circle mt-4 mb-2 overflow-hidden"
                    fluid
                    style={{ zIndex: "1" }}
                  />
                  {lawyer?.available ? (
                ...
                <div className="ms-5 mt-5">
                  <MDBTypography tag="h5" className=" display-6 text-dark">
              ...
              <MDBCardBody className="text-black p-4">
                ...
                <div className="m-5">
                  <select
                    ...
                    id="select"
                    className="browser-default custom-select border-4"
                  >
                ...
                <MDBBtn
                  ...
                  onClick={
                    cookie.set("categoryName", selectedOption, {
                      expires: 7,
                    }) &&
                    cookie.set("emailPayment", lawyer?.email, { expires: 7 })
                  }
                  className=" me-2"
                >
                  <a href={`/payment/${sub?._id}`}>Hire me </a>
                </MDBBtn>
                <MDBBtn className=" ms-2" onClick={PopUpContact}>
                  Contact me {popUp ? <ContactLawyer lawyer={lawyer} /> : ""}
                </MDBBtn>
              </MDBCardBody>
            </MDBCard>
          </MDBCol>
